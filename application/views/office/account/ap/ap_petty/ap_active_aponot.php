<div class="table-responsive">
  <table class="basic table table-hover table-xxs datatable-basic">
    ...
    <tbody>
        <?php $n=1; foreach ($not as $val) {?>
        <tr>
          <td><?php echo $n; ?></td>
            <td><?php echo $val->ap_no; ?></td>
            <td><?php echo $val->doc_date; ?></td>
            ...
            <td>
              <ul class="icons-list">
              <li><a href="<?php echo base_url(); ?>ap/ap_edit_apo/<?php echo $val->ap_no; ?>/<?php echo $val->ap_type; ?>" data-popup="tooltip" title=""><i class="icon-pencil7"></i></a></li>
                <li><a data-toggle="modal" data-target="#deleteapo<?php echo $val->ap_no;?>"><i class="icon-trash"></i></a></li>
                <li><a href="<?php echo base_url();?>report/viewerloadgl?module=ap&typ=report&reportname=apo_payvoucher.mrt&no=<?php echo $val->ap_no; ?>&compcode=<?=$compcode;?>" target="_blank" data-popup="tooltip" title="" data-original-title="Open"><i class="icon-printer4"></i></a></li>
              </ul>
            </td> 
        <?php }else{ ?>
