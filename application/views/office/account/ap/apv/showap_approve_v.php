          ...
          <div class="panel-heading">
            ...
            <div class="panel-body">  
              ...
              <div class="text-right">
              	<a class="btn bg-teal-400" href="<?php echo base_url();?>report/viewerloadgl?module=ap&typ=report&reportname=ap_approve_report.mrt&no=<?php echo $ap_code; ?>&compcode=<?php echo $compcode;?>" target="_blank">Print Cheque</a>

              	<a class="btn btn-warning" href="<?php echo base_url();?>report/viewerloadgl?module=ap&typ=report&reportname=ap_cheque_report.mrt&no=<?php echo $ap_code; ?>&compcode=<?php echo $compcode;?>" target="_blank">Print Voucher</a>

              	<a class="btn btn-success" href="<?php echo base_url();?>report/viewerloadgl?module=ap&typ=report&reportname=ap_wt.mrt&no=<?php echo $ap_code; ?>&compcode=<?php echo $compcode;?>" target="_blank">Print WT</a>
