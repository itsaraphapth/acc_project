                    ...
                    frm.submit(function (ev) {
                        $.ajax({
                            ...
                            data: frm.serialize(),
                                ...
                                setTimeout(function() {
                                window.location.href = "<?php echo base_url();?>report/viewerloadgl?module=ap&typ=report&reportname=apo_payvoucher.mrt&no=<?php echo $apocode; ?>&compcode=<?php echo $compcode;?>";
